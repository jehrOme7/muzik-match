...
Leaving the quiz while its result animation is running cancels the pending result; returning to the quiz lets the user submit again. Rapid repeat submissions do not schedule duplicate results.
